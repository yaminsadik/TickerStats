      ...
      <div className="p-6 space-y-6 text-gray-300">
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed">
            This DCF (Discounted Cash Flow) model computes an intrinsic value by
            forecasting future free cash flows and discounting them to present
          ...
          <div className="space-y-4">
            <div className="bg-slate-800 rounded-lg p-4">
              ...
              <p className="text-xs text-gray-400 mt-2">
                FCF_0 is base FCF from yfinance, growth is your FCF growth rate
                assumption, t is year 1 to N.
              </p>
            </div>
            ...
            <div className="bg-slate-800 rounded-lg p-4">
              ...
              <p className="text-xs text-gray-400 mt-2">
                Each year's FCF is discounted to present value using your WACC
                assumption.
              </p>
            </div>
...
FCF_(N+1) = FCF_N × (1 + g)`}
              ...
              <p className="text-xs text-gray-400 mt-2">
                Terminal value represents all cash flows beyond year N, assuming
                perpetual growth at rate g. Note: g must be less than WACC.
              </p>
            </div>
            ...
            <div className="bg-slate-800 rounded-lg p-4">
              ...
              <p className="text-xs text-gray-400 mt-2">
                Add cash (belongs to equity holders), subtract debt (claims on
                enterprise).
              </p>
            </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-slate-700">
                ...
                <tr>
                  ...
                  <td className="py-2 text-slate-400 font-mono text-xs">
                    balance_sheet / info.totalCash
                  </td>
                </tr>
                <tr>
                  <td className="py-2">Debt</td>
                  <td className="py-2 text-slate-400 font-mono text-xs">
                    balance_sheet / info.totalDebt
                  </td>
                </tr>
                <tr>
                  <td className="py-2">FCF (Base)</td>
                  <td className="py-2 text-slate-400 font-mono text-xs">
                    cashflow: Operating CF − CapEx
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <section className="bg-amber-900/30 border border-amber-700 rounded-lg p-4">
          ...
          <p className="text-xs text-slate-300 leading-relaxed">
            ...
            If yfinance is missing a value (shown as "manual required" in
            sources), you must enter it manually. The calculation will not
            proceed with missing required inputs to avoid producing misleading
            valuations.
          </p>
        </section>
      </div>
