  ...
  return (
    ...
    >
      <div className="space-y-6 text-gray-300">
        {/* Overview */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-2">What is DCF?</h3>
          <p className="text-sm leading-relaxed">
            Discounted Cash Flow (DCF) is a valuation method that estimates the intrinsic value 
            of a company based on its projected future cash flows, discounted back to present value.
          </p>
        </section>

        {/* Calculation Steps */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3">Calculation Steps</h3>
          <div className="space-y-4">
            <div className="bg-slate-800 rounded-lg p-4">
              <h4 className="font-medium text-white mb-2">1. Get Free Cash Flow (FCF)</h4>
              <p className="text-sm mb-2">Starting point from company's most recent financials:</p>
            ...
            <div className="bg-slate-800 rounded-lg p-4">
              <h4 className="font-medium text-white mb-2">2. Project Future Cash Flows (5 years)</h4>
              <p className="text-sm mb-2">Grow FCF based on historical revenue growth, with decay:</p>
...
Year 5 FCF = Year 4 FCF × (1 + terminal_growth)`}
            ...
            <div className="bg-slate-800 rounded-lg p-4">
              <h4 className="font-medium text-white mb-2">3. Discount to Present Value</h4>
              <p className="text-sm mb-2">Apply WACC (Weighted Average Cost of Capital) discount:</p>
              <code className="block bg-slate-900 p-3 rounded text-xs text-green-400 whitespace-pre">
...
PV of Projected FCF = Σ (each year's PV)`}
            ...
            <div className="bg-slate-800 rounded-lg p-4">
              <h4 className="font-medium text-white mb-2">4. Calculate Terminal Value</h4>
              <p className="text-sm mb-2">Value beyond Year 5 using Gordon Growth Model:</p>
              <code className="block bg-slate-900 p-3 rounded text-xs text-green-400 whitespace-pre">
...
PV of Terminal = Terminal Value / (1 + WACC)^5`}
            ...
            <div className="bg-slate-800 rounded-lg p-4">
              <h4 className="font-medium text-white mb-2">5. Enterprise to Equity Value</h4>
...
Equity Value = Enterprise Value - Total Debt + Cash`}
            ...
            <div className="bg-slate-800 rounded-lg p-4">
              <h4 className="font-medium text-white mb-2">6. Per Share Value</h4>
              <code className="block bg-slate-900 p-3 rounded text-xs text-green-400">
        ...
        {/* Upside Calculation */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3">DCF Upside Calculation</h3>
          <div className="bg-slate-800 rounded-lg p-4">
            <p className="text-sm mb-3">
              Upside represents the potential return from current price to fair value:
            </p>
            <code className="block bg-slate-900 p-3 rounded text-xs text-green-400">
            ...
            <div className="mt-4 space-y-2 text-sm">
              ...
              <div className="flex items-start gap-2">
                ...
                <span>→ Stock is overvalued; would need to drop 40% to reach fair value</span>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Key Assumptions */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-2">Key Assumptions</h3>
        ...
        <section className="bg-amber-900/20 border border-amber-700/50 rounded-lg p-4">
          <h3 className="text-lg font-semibold text-amber-400 mb-2">Limitations</h3>
