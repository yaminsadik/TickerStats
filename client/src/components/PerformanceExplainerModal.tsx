...
export function PerformanceExplainerModal({ isOpen, onClose }: PerformanceExplainerModalProps) {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
    ...
    >
      <div className="space-y-6 text-gray-300">
        {/* Overview */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-2">What are Performance Metrics?</h3>
          <p className="text-sm leading-relaxed">
            Performance metrics measure how a stock has performed over a specific time period,
            including returns and risk characteristics. These are backward-looking indicators
        ...
        {/* Return */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3">Total Return</h3>
          <div className="bg-slate-800 rounded-lg p-4 space-y-3">
            <p className="text-sm">
              Total return measures the percentage change in stock price over the selected period,
        ...
        {/* Volatility */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3">Volatility (Standard Deviation)</h3>
          <div className="bg-slate-800 rounded-lg p-4 space-y-3">
            <p className="text-sm">
              Volatility measures the degree of price fluctuation. Higher volatility means
              larger price swings (higher risk and potentially higher reward).
            </p>
        ...
        <section>
          ...
          <div className="bg-slate-800 rounded-lg p-4 space-y-3">
            <p className="text-sm">
              ...
              It shows the worst-case scenario an investor would have experienced.
            </p>
            <code className="block bg-slate-900 p-3 rounded text-xs text-green-400 whitespace-pre">
...
4. Max Drawdown = (Trough - Peak) / Peak × 100`}
            ...
            <div className="mt-3 bg-slate-900 rounded p-3 text-xs">
              ...
              <ul className="space-y-1 text-gray-300">
                ...
                <li>• Max Drawdown = (70 - 100) / 100 = <span className="text-red-400 font-bold">-30%</span></li>
              </ul>
            </div>
        ...
        {/* Time Periods */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-3">Time Periods</h3>
          <div className="bg-slate-800 rounded-lg p-4">
            <p className="text-sm mb-3">
              Performance can be calculated over different periods:
            </p>
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div><span className="font-medium text-white">1mo, 3mo, 6mo:</span> Short-term</div>
              <div><span className="font-medium text-white">ytd:</span> Year-to-date</div>
              <div><span className="font-medium text-white">1y, 2y:</span> Medium-term</div>
              <div><span className="font-medium text-white">5y, 10y:</span> Long-term</div>
              <div className="col-span-2"><span className="font-medium text-white">max:</span> Since inception or earliest available data</div>
            </div>
          </div>
        </section>
        ...
        {/* Use Cases */}
        <section>
          <h3 className="text-lg font-semibold text-white mb-2">How to Use These Metrics</h3>
          <ul className="space-y-2 text-sm list-disc list-inside">
            <li><strong className="text-white">Return:</strong> Compare absolute performance across stocks</li>
            <li><strong className="text-white">Volatility:</strong> Assess risk tolerance and price stability</li>
            <li><strong className="text-white">Max Drawdown:</strong> Understand worst-case scenario and recovery ability</li>
            <li><strong className="text-white">Combined:</strong> Evaluate risk-adjusted returns (higher return with lower volatility is ideal)</li>
          </ul>
        </section>

        {/* Limitations */}
        <section className="bg-amber-900/20 border border-amber-700/50 rounded-lg p-4">
          <h3 className="text-lg font-semibold text-amber-400 mb-2">Important Notes</h3>
